...
\verb|routing/spatio_semantic.py| contains the core logic. The following listing summarizes the core utility calculation used by the Spatio-Semantic router.
